  ...
  return (
    <Container>
      <div className="relative md:min-h-screen font-poppins flex justify-center md:items-center gap-6 flex-wrap">
        ...
        <h2 className="lg:absolute md:left-[30%] md:top-[18%] lg:text-7xl md:text-5xl text-4xl font-semibold text-green-600 max-w-[900px] z-20">
          Nature's Playground: Enjoy with Bikes!
        </h2>
        ...
        <FramerUp>
          <div className="md:pt-48 text-lg max-w-[400px]">
            <p>
              ...
              iscover the way of Enjoying your life by renting bikes
            </p>
            <p className="px-2 my-4 text-base">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              Voluptates sapiente reiciendis laboriosam dolorum, quidem repellat
              dolorem dignissimos laborum commodi qui voluptas reprehenderit
              illo odit quos quod, corrupti saepe praesentium animi at
              voluptatem! At debitis, quibusdam non reiciendis.
            </p>

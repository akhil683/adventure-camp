...
const ProductCard = ({ handleCart }) => {
  return (
    <div className='sm:max-w-[300px] w-full p-4  rounded-lg hover:bg-gray-200 hover:shadow-2xl hover:shadow-gray-300 duration-200'>
      <Link to="/product">
      ...
      <button onClick={handleCart} className='flex justify-center items-center gap-2 uppercase font-roboto w-full py-2 rounded-lg bg-green-600 hover:bg-black duration-200 text-white'>

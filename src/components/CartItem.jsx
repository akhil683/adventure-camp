        ...
        <div className="flex justify-between items-end">
          <div className="flex md:gap-6 gap-4 md:mt-6 mt-2 md:text-sm text-xs text-gray-600">
            <button
              ...
              className="flex gap-2 items-center hover:text-gray-700 px-2 py-1 hover:bg-gray-200 rounded-md duration-200"
            >
              <MdDelete /> Remove
            </button>
          </div>
          <p className="md:text-3xl text-lg font-bebasNeue text-red-600">
            <strike className="mr-2 md:text-base text-sm text-gray-600">
              &#8377;{actualPrice}
            </strike>
            &#8377;{price}
          </p>

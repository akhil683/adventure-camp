  ...
  return (
    <Container>
      <div className='relative md:min-h-screen font-poppins flex justify-center md:items-center gap-6 flex-wrap'>
         ...
         <h2 className='md:absolute md:left-[30%] md:top-[18%] md:text-7xl text-4xl font-semibold text-green-600 max-w-[900px] z-20'>Nature's Playground: Enjoy with Bikes!</h2>
